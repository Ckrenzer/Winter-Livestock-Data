...
lajunta$Type <- lajunta %>% 
  ...
  str_replace_all("red\\s+black\\s+(ang)", "\\1") %>% #(removing combinations of colors) *** this section is likely giving us problems
...
# This correction of the Type column is done after finding errors explicitly. I am 'hard-coding' in the correct value.
# lajunta$Type <- lajunta %>% 
#   dplyr::select(Type) %>% 
#   unlist() %>% 
