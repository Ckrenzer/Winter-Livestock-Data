...
collection <- function(urls){
  ...
  for(URL in urls){
    ...
    # simple yet effective way of showing an the operation's progress
    cat(".")
    ...
    #says that data was added to the file
    cat("\nDATA ADDED\n")
...
I have been changing the URLs around to find different data, but the 11000 to 13500 ballpark seems to be the best range for La Junta.

```{r urls-execute}

# This just parses together different market report IDs
urls <- paste0("http://www.winterlivestock.com/lajunta.php?reportID=", 10000:13500, "#marketreport")
