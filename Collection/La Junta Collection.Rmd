  ...
  for(URL in urls){
    ...
    for(i in 1:length(livestock_data)){
      ...
      if(str_detect(livestock_data[i], "\n?\t\t|^\\d")){#if a multiple purchase:
        ...
        #add the \t to the buyer name
        livestock_data[i] <- str_replace(livestock_data[i], buyers[current_ID+1], paste0(buyers[current_ID+1], "\t"))
...
urls <- c("http://www.winterlivestock.com/lajunta.php?reportID=13343#marketreport",
"http://www.winterlivestock.com/lajunta.php?reportID=13373#marketreport")
