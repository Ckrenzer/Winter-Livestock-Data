...
BEFORE RUNNING, SAVE A COPY OF THE CSV FILE IN ANOTHER FOLDER SO THAT YOU DO NOT HAVE TO RUN THE ABOVE CHUNKS AGAIN (should the cleaning script have problems)!
...
# this one is especially useful, so I'm storing it into a variable
counts <- count(lajunta, Type) %>% 
  arrange(desc(n)) %>% 
  as.data.frame()
...
# also remember that KNN is probably the best imputation method for this data
