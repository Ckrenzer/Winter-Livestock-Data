---
title: "La Junta Classification Models"
...
From my previous work (see "[Overview.Rmd](https://github.com/Ckrenzer/Winter-Livestock-Data/blob/main/Archived/Overview.Rmd)," for instance), I can confidently say that the "Type" column is *utterly* useless. That's a story in and of itself, I suppose. The simplest graph that tells the bulk of what we need to know is this one:
