...
# separating the data into two new data frames
lajunta_lda_train <- rsample::training(lajunta_knn_split)
lajunta_lda_test <- rsample::testing(lajunta_knn_split)
```
...
lajunta_LDA_fit <- MASS::lda(Reprod ~ Price + Weight + Quantity + Date,
