...
I expect there to be zero errors in the third test.

### Setup

First things first. Let's make some data for each of the categories in the models:
...
# A logistic regression determining whether a variable is RR or not
