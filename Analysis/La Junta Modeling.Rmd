...
You can see that we have data for when the sale took place, the quantity sold, the type of livestock, the weight in pounds, the price in USD, and the livestock's reproductive status. There is also data on Buyer names, but I thought it would be rude to include in this table.

From my previous work with this data (see "La Junta Predictions.Rmd," for instance), I can tell you that the "Type" column is basically useless. The most telling graph I can provide you is this one:
...
We can clearly see four distinct groups, which will be observed in various ways.
