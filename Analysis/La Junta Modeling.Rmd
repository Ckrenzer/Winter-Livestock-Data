...
Sensitivity for the first regression:
```{r sensitivity (logit1), echo = FALSE, results = "show"}
#calculate sensitivity
cat(InformationValue::sensitivity(lajunta_logit1_test$Reprod, logit1_test_probs))


```
The data were classified correctly in the test data `cat(InformationValue::sensitivity(lajunta_logit1_test$Reprod, logit1_test_probs))` of the time.
