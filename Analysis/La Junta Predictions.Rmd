...
I want to bring your attention to the distinct types of cattle and how many of them appear in the data.
...
knitr::kable(lajunta %>% 
               count(Reprod) %>% 
               rename("Number of Obs" = n, "Reproductive Status" = Reprod))
...
Compare the estimated price with the graphs above to compare with the rest of the data.
...
### Heifers
```{r hfr predictions, results = "show"}
ui <- fluidPage(
  
  # The three inputs we are interested in seeing
  dateInput("date", "What is the date of the sale?"),
  numericInput("quantity", "How many are being sold?", 1, min = 1),
  numericInput("weight", "What is the livestock's weight in pounds?", 600, min = 25),
...
### Cows
```{r cow predictions, results = "show"}
ui <- fluidPage(
  
  # The three inputs we are interested in seeing
  dateInput("date", "What is the date of the sale?"),
  numericInput("quantity", "How many are being sold?", 1, min = 1),
  numericInput("weight", "What is the livestock's weight in pounds?", 1250, min = 25),
...
### Bulls
```{r bull predictions, results = "show"}
ui <- fluidPage(
  
  # The three inputs we are interested in seeing
  dateInput("date", "What is the date of the sale?"),
  numericInput("quantity", "How many are being sold?", 1, min = 1),
  numericInput("weight", "What is the livestock's weight in pounds?", 2150, min = 25),
