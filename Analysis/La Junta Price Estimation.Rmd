...
See the accompanying Shiny app ("[Overview.Rmd](https://github.com/Ckrenzer/Winter-Livestock-Data/blob/main/Analysis/Overview.Rmd)," also linked above) if you'd like to play with these linear models yourself!
