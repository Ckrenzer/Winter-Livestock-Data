...
ts(na.omit(avg_steer_prices$cleaned_price), frequency=8) 
str(avg_steer_prices)



decomp <- stl(ts(na.omit(avg_steer_prices$cleaned_price), frequency=8) , s.window="periodic")
