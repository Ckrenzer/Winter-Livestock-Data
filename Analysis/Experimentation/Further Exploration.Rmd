...
```{r prices over time, results = "show"}
...
```{r moving average plots, results = "show"}

# steers
simple_moving_average(df = lajunta, reprod_status = "str", variable_name = Price, n = 52) %>% 
  ggplot() +
...
# heifers
simple_moving_average(df = lajunta, reprod_status = "hfr", variable_name = Price, n = 52) %>% 
  ggplot() +
  geom_line(mapping = aes(x = Date, y = Avg_Price), color = "orange", size = 1) +
...
# cows
simple_moving_average(df = lajunta, reprod_status = "cow", variable_name = Price, n = 52) %>% 
  ggplot() +
  geom_line(mapping = aes(x = Date, y = Avg_Price), color = "orange", size = 1) +
...
# bulls
simple_moving_average(df = lajunta, reprod_status = "bull", variable_name = Price, n = 52) %>% 
  ggplot() +
  geom_line(mapping = aes(x = Date, y = Avg_Price), color = "orange", size = 1) +
