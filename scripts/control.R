...
{# Setup -----------------------------------------------------------------------
    ...
    urls <- local({
        webpage <- shell("curl https://www.winterlivestock.com/lajunta.php", intern = TRUE, mustWork = TRUE)
        ...
        str_glue("http://www.winterlivestock.com/lajunta.php?reportID={reportID}#marketreport")
    })
...
{# Load Market Reports ---------------------------------------------------------
    ...
    urls <- c(str_c("http://www.winterlivestock.com/lajunta.php?reportID=",
    ...
    if(ready_to_save){
        ...
        fwrite(lajunta, "data-info/wl_raw.csv", compress = "gzip")
    ...
    if(ready_to_save){
        fwrite(lajunta, "data-info/wl_market_reports.csv", compress = "gzip")
    }
